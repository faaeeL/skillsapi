    ...
    public void apply(SkillContext context) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                // Falls back to a fixed reference axis on the (near-)vertical
                // edge case where forward is parallel to world-up and the
                // cross product would otherwise degenerate to zero.
                Vector forward = caster.getEyeLocation().getDirection().clone().normalize();
